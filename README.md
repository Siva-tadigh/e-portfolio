# MSc Computer Science — Learning Portfolio Template

A small static site for a two-year MSc: one "About Me" page, plus one page
per module, grouped by year. Built as plain HTML/CSS so it needs no build
step and hosts directly on GitHub Pages.
...
3. In **every** page's spine nav (including `index.html` and all other
   ...
   under the correct year — the nav is already split into a "Year 1" and
   "Year 2" `<p class="spine__section-label">` block for the two-year MSc.
